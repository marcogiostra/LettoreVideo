...
{
    public partial class KnobGioshControl : UserControl
    {
        /// <summary> 
        ...
        private System.Drawing.Font _scaleFont;
        ...
        private System.Drawing.Color _PointerColor = Color.SlateBlue;
        ...
        // Classe per passare il nuovo valore
        ...
        */
        ...
        private void DrawPointer(Graphics Gr)
        {
            try
            {
                ...
                else
                {
                    ...
                    //DrawInsetCircle(ref Gr, rPointer, new Pen(_PointerColor));
        ...
        #region f()
        public float GetRadian(float val)
        {
        ...
        public void DrawInsetCircle(ref Graphics g, Rectangle r, Pen p)
        {
